...
Both work. Saturation first means the compressor reacts to softened peaks and works less. Saturation after means the compressor's shape drives the saturator, so transients bite harder. Try both and keep the one you prefer.
