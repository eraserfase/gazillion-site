...
The practical side is in how to use saturation in a mix and how to saturate drums.

BEEFY covers the whole range with one big knob, from a little weight to a lot of rude. The demo on the page is 28 seconds.
