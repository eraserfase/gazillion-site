# The Sausage Fattener, and how BEEFY is different

> What the Sausage Fattener is, in its makers' own words, what reviewers measured, what is not documented about it, and where BEEFY's controls work differently.

Source: https://gazillionindustries.com/sausage-fattener-vs-beefy/  
Published 2026-09-20, updated 2026-09-24. By Gazillion Industries, who make BEEFY.

---

Two knobs, a price under forty dollars, and a decade of producers reaching for it when a sound needs to stop being polite. It is one of the most widely used plugins in electronic music, and we make something that lives in the same aisle, so it is worth laying both out honestly instead of pretending the other one is not there.

The Sausage Fattener is a saturation and loudness plugin released under the Dada Life name and built by Tailored Noise. It has three controls: FATNESS, COLOR, and a small GAIN with a clipping lamp. BEEFY is our saturation and loudness effect, with BEEF, COOK and JUICE plus two switchable output stages. They are aimed at a similar result and they are built around different decisions, and the differences are in what each one gives you a control over.

## The short version

- **Their controls**: FATNESS, COLOR, GAIN, and a clip lamp

- **Our controls**: BEEF, COOK, JUICE, plus SOFT CLIP and LIMIT
...
The makers have said very little about what is inside, and that is a deliberate position rather than an oversight. Their own FAQ describes it as "a combination of several dynamic effects", with the key being to "drive the signal as hard as you want — from mild compression to hard distortion". When Computer Music reviewed it in 2011, the writer noted that the developers were keeping tight-lipped about the signal path.

Since then people have measured it. Sound On Sound's reviewer in 2011 described hearing brick-wall limiting along with compression. A more recent analysis using measurement software reported a soft clipper with a compressor in front of it and a fixed low cut. Those are other people's findings about someone else's product, and they are reported here as that: attributed observations, not facts from the manufacturer.

One thing genuinely is not documented anywhere, in either direction: whether it oversamples. We are not going to guess, and neither should anyone else.
...
### What does the Sausage Fattener do?

Its makers describe it as a combination of several dynamic effects driven as hard as you like, from mild compression to hard distortion, controlled with FATNESS and COLOR plus a small gain knob. The internal signal path is not published.

### How much does it cost?

$39 at the time of writing, and $29 when it launched in 2011. Bundles with the makers' other plugins are also sold.

### Is BEEFY a copy of the Sausage Fattener?

No. BEEFY is tuned by ear, with its own control set: three knobs plus separate soft clip and limit switches, and input and output clip indicators. Both plugins live in the same category, the way two compressors do.
